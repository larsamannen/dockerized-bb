...
m4_define(`IPHONE_SDK_VERSION',11.4)m4_dnl
...
helpers_package(giflib, CFLAGS="-fembed-bitcode" CPPFLAGS="-fembed-bitcode" LDFLAGS="-fembed-bitcode")

helpers_package(faad2, CFLAGS="-fembed-bitcode" CPPFLAGS="-fembed-bitcode" LDFLAGS="-fembed-bitcode")
...
local_package(fluidsynth, -DCMAKE_SYSTEM_NAME=Darwin -DCMAKE_C_FLAGS="-fembed-bitcode" -DCMAKE_CXX_FLAGS="-fembed-bitcode" -DCMAKE_EXE_LINKER_FLAGS="-fembed-bitcode" -DLIB_SUFFIX=)
