...
do_make CFLAGS="-fembed-bitcode" CPPFLAGS="-fembed-bitcode" LDFLAGS="-fembed-bitcode"
...
# No binaries, no man, ...
do_make -C gettext-runtime/intl CFLAGS="-fembed-bitcode" CPPFLAGS="-fembed-bitcode" LDFLAGS="-fembed-bitcode"
